...
/* =========================================================
   ...
   • One Active Option Per Material Group
   • Editable Rate
   • Quantity
...
/*
   ACTIVE OPTION PER MATERIAL GROUP
   ...
   This makes sure that only ONE option
   from a dropdown group is active at a time.
*/
...
function initializeActiveSelections() {
...
/* =========================================================
   ...
   ---------------------------------------------------------
   IMPORTANT FIX:
   Active dropdown option is now stored
   separately by group.
========================================================= */
...
function getSelectedMaterial(
    ...
    if (!group || !group.materials.length) {
...
/* =========================================================
   GET GROUP KEY FOR MATERIAL
========================================================= */

function getMaterialGroupKey(
    material
) {
    ...
    return `${material.stage}__${material.name}`;

}


/* =========================================================
   CHECK WHETHER MATERIAL IS ACTIVE
========================================================= */
...
/* =========================================================
   ...
   ---------------------------------------------------------
   IMPORTANT:
   Only ACTIVE option of each group is counted.
========================================================= */
...
console.log(
    "Sandeep ElectroFix Material Estimate Engine v2.1.0 Loaded"
);
